...
void help(char* comm){
  if (comm == NULL){
    ...
    printf("\n    [NEGATIVE]         Mise en n̩gatif.");
    printf("\n    [BLACKNWHITE]      Mise en noir et blanc.");
    printf("\n    [REPLACE_COLOR]    Remplacement d'une couleur donn̩e.");
    printf("\n    [FILL_COLOR]       Remplissage par une couleur donn̩e.");
    printf("\n    [LIGHT]            Ajustement de la luminosit̩.");
